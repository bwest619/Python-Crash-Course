...
class Battery():
    ...
    def upgrade_battery(self):
        """Checks the battery size and sets capacity if it is not already"""
        if self.battery_size == 70:
            self.battery_size = 85
            print("Upgraded your battery size!")
        else:
...
my_tesla.battery.get_range()
my_tesla.battery.upgrade_battery() # Try to upgrade your battery a second time
my_tesla.battery.get_range()